...
import com.sithagi.sithbox.database.data.provider.SithBoxContent.account;
...
public final class SithBoxProvider extends ContentProvider {

    private static final String LOG_TAG = SithBoxProvider.class.getSimpleName();

    /* package */ static final boolean ACTIVATE_ALL_LOGS = false;

    protected static final String DATABASE_NAME = "SithBoxProvider.db";

    public static final String AUTHORITY = "com.sithagi.sithbox.database.provider.SithBoxProvider";
    ...
    private enum UriType {
        ACCOUNT(account.TABLE_NAME, account.TABLE_NAME, account.TYPE_ELEM_TYPE),
        ACCOUNT_ID(account.TABLE_NAME + "/#", account.TABLE_NAME, account.TYPE_DIR_TYPE);
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            Log.d(LOG_TAG, "Creating SithBoxProvider database");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            account.upgradeTable(db, oldVersion, newVersion);
        }
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        try {
            switch (uriType) {
                case ACCOUNT:
                    insertStmt = db.compileStatement(account.getBulkInsertString());
                    for (ContentValues value : values) {
                        account.bindValuesInBulkInsert(insertStmt, value);
                        insertStmt.execute();
